...
<p>O cumprimento da NR-35 é fundamental para garantir a <strong>segurança e saúde dos trabalhadores</strong> envolvidos direta ou indiretamente em atividades em altura.</p>`
    ...
    function renderNrGrid(data) {
        const nrOrder = ['01','04','05','06','09','10','11','12','15','16','17','18','19','20','22','23','33','35','38'];
        let gridItems = '';
            ...
            <section class="section" style="padding-top: 80px;">
                <div class="container">
                    ...
                    <p style="text-align: center; max-width: 700px; margin: -20px auto 50px; color: var(--text-light); font-size: 1.05rem; line-height: 1.7;">
                        Conheça as principais Normas Regulamentadoras de Segurança e Saúde no Trabalho aplicadas pela EngFoco.
                    </p>
                    <div class="nr-grid">
                        ${gridItems}
                    </div>
